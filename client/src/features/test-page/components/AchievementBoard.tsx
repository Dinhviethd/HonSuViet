...
export function AchievementBoard({ achievements }: AchievementBoardProps) {
	return (
		<div className="grid grid-cols-2 md:grid-cols-5 gap-4">
			<Card className="bg-[rgb(209,36,32)] text-white border-none">
			...
			<Card className="bg-[rgb(230,108,60)] text-white border-none">
				<CardContent className="p-6 text-center">
			...
			<Card className="bg-[rgb(33,83,76)] text-white border-none">
				<CardContent className="p-6 text-center">
			...
			<Card className="bg-[rgb(122,183,193)] text-white border-none">
				<CardContent className="p-6 text-center">
			...
			<Card className="bg-[rgb(111,77,56)] text-white border-none">
				<CardContent className="p-6 text-center">
