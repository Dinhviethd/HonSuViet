...
const chapter_entity_1 = require("../../lesson/entities/chapter.entity");
let Quiz = class Quiz {
    idQuiz;
    chapter;
    author;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => chapter_entity_1.Chapter, { onDelete: 'SET NULL', nullable: true }),
...
__decorate([
    ...
    __metadata("design:type", String)
], Quiz.prototype, "topicTag", void 0);
__decorate([
